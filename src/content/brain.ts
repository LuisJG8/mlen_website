export const brainTopics = [
  ...
  {
    title: 'Peer sessions',
    body: 'Join talks, reading groups, demos, and hands-on sessions that turn community discussion into shared context.',
    x: 652,
    y: 182,
    size: 'small',
    tone: 'dark',
...
export const brainNodes = [
  ...
  { id: 6, x: 27, y: 328, size: 'small', tone: 'cyan', interactive: false },
  { id: 7, x: 61, y: 175, size: 'small', tone: 'dark', interactive: false },
  { id: 8, x: 180, y: 74, size: 'small', tone: 'dark', interactive: false },
  { id: 9, x: 533, y: 74, size: 'small', tone: 'dark', interactive: false },
  { id: 10, x: 600, y: 320, size: 'small', tone: 'dark', interactive: false },
  { id: 11, x: 687, y: 327, size: 'small', tone: 'dark', interactive: false },
  { id: 12, x: 624, y: 407, size: 'small', tone: 'dark', interactive: false },
  { id: 13, x: 467, y: 483, size: 'small', tone: 'dark', interactive: false },
  { id: 14, x: 432, y: 573, size: 'small', tone: 'dark', interactive: false },
  { id: 15, x: 134, y: 397, size: 'small', tone: 'dark', interactive: false },
] as const;
...
export const accentBrainEdges = new Set(['0-1', '0-2', '0-6']);
